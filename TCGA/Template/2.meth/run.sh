...
/home/lixuefei/Pipeline/Basic/Plot/Heatmap.R -m MethAnnotation.txt -scale column -cluster_cols -cluster_rows -fontsize 10 -annotation_col ../0.RawData/Final/TrainSampleClass.txt -breakup=1 -breakdown=-1
cd ../

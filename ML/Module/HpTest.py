...
def GetBinaryTest(pd1, pd2, test):
    ...
    if test == 'fisher':
        for i in range(length):
            ...
            list_tp = list(set(list_2))
            for m in range(len(list_1)):
                if list_1[m] == 0 and list_2[m] == list_tp[0]:
                    a += 1
                elif list_1[m] == 0 and list_2[m] == list_tp[1]:
                    b += 1
                elif list_1[m] == 1 and list_2[m] == list_tp[0]:
                    c += 1
                elif list_1[m] == 1 and list_2[m] == list_tp[1]:
                    d += 1

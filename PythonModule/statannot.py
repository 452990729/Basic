...
def stat_test(box_data1, box_data2, test):
    ...
    if test == 'Mann-Whitney':
        ...
        stat, pval = stats.ranksums(a=box_data1, b=box_data2)
        testShortName = 'ranksums'
        formattedOutput = "ranksums, P_val={:.3e} stat={:.3e}".format(pval, stat)
...
def add_stat_annotation(ax,
                        ...
                        boxPairList=None,
                        test='ranksums', textFormat='star', loc='inside',
